...
```hcl
github.com/pbs/terraform-aws-s3-module?ref=3.0.4
```
...
```hcl
module "s3" {
  source = "github.com/pbs/terraform-aws-s3-module?ref=3.0.4"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_s3_policy"></a> [s3\_policy](#module\_s3\_policy) | github.com/pbs/terraform-aws-s3-bucket-policy-module | 1.0.12 |
