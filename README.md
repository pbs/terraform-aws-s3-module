...
```hcl
github.com/pbs/terraform-aws-s3-module?ref=4.0.15
```
...
| <a name="input_use_prefix"></a> [use\_prefix](#input\_use\_prefix) | Use a suffix with  the bucket name (treat the `name` as a prefix) | `bool` | `true` | no |
